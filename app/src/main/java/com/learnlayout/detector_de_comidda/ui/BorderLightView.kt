...
class BorderLightView @JvmOverloads constructor(
    ...
    // Padding para que no roce el botón
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // Path con padding para separarse del borde del botón
        val path = Path().apply {
            addRoundRect(
        ...
        // Path CW empieza en el centro-derecha.
        // Top-center = 75% del recorrido total
        val topCenter = total * 0.75f

        // Luz 1: avanza hacia la derecha desde top-center
        drawLight(canvas, pm, total, topCenter, progress, true)
        // Luz 2: avanza hacia la izquierda desde top-center
    ...
    private fun drawLight(
        ...
        // La punta avanza 0.5 del total como máximo (llega al bottom-center)
        val travel = progress * total * 0.64f
        ...
        while (remaining > 0f) {
            ...
            // La cola va en dirección opuesta a la punta
